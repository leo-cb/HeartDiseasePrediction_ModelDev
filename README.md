...
Posteriorely, the GBT model was replicated in the local environment, in create_model.py. The model explainability was implemented with SHAP in explain_model.py. Images of the various steps in the pipeline can be found in /images/.
